...
# Allow testing with external firmware and
# avoid user input prompts during bulk testing
import due.serial
class DueTestRecovery(due.serial.DueRecovery):
    def __init__(self):
        super().__init__()
        self.verbose = True
...
import ez.repl
ez.repl.register({
    ez.repl.Recovery: lambda: DueTestRecovery(),
})
...
if __name__ == '__main__':
    ...
    info = ez.util.test.lock_device(due.serial.accept, args.connect)
